    ...
    case 1:
        DisplayColumnsTpl = _.template(
             '<tr>'
				...
				+ '<% if (typeof(card.faction2_code) !== "undefined" && card.faction2_code) { %>'
				+   '<span class="fa fa-circle fg-<%= card.faction2_code %>"></span> '
				+ '<% } %>'
				...
				+ '<td class="faction">'
				+   '<span class="fg-<%= card.faction_code %>" title="<%= card.faction_name %>"><%= card.faction_name %></span>'
				+   '<% if (typeof(card.faction2_code) !== "undefined" && card.faction2_code) { %>'
				+     ' <span class="fg-<%= card.faction2_code %>" title="<%= card.faction2_name %>"><%= card.faction2_name %></span>'
				+   '<% } %>'
				+ '</td>'
				+ '<td class="fm_code">'
				...
				+ 'traitArr.forEach(function(t) { if(t==="S.H.I.E.L.D.") t="SHIELD"; if(t==="S.W.O.R.D.") t="SWORD"; %>'
